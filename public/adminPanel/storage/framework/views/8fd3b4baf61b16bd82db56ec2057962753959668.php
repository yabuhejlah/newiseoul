                ...
                <div class="row clearfix js-sweetalert">
                    ...
                    <div class="col-md-12">
                        <div align="right">
                            ...
                            <button type="button" onclick="selectFood()" class="q-btn-all q-color-second-bkg waves-effect"><h5><?php echo e($lang->get(120)); ?></h5></button>
                            <?php endif; ?>
                        </div>
                    </div>
    ...
    function selectFood(){
        ...
        <?php $__currentLoopData = $foods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            text = text +"</td><td><?php echo e($data->restaurantName); ?></td>" +
                "<td><div onclick=\"addFood(<?php echo e($data->id); ?>)\" class=\"q-btn-all q-color-second-bkg waves-effect\"><h5><?php echo e($lang->get(181)); ?></h5></div></td></tr>";
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        text = text + "                </tbody>\n" +
            "                </tbody>\n" +
            "                </table>\n</div></div></div>"
...
<?php echo $__env->make('bsb.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restaurants\resources\views/topfoods.blade.php ENDPATH**/ ?>