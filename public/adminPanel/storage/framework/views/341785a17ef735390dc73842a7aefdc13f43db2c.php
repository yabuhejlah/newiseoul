        ...
        <script>
            ...
            function appendChildToTable(id, visible){
                if (id == "topr") {
                    ...
                    tr.id = "tr_topr";
                    tr.innerHTML = oneItem("<?php echo e($lang->get(392)); ?>", "topr", "uitopr.jpg"); // Top Restaurants this week
                ...
                if (id == "topf") {
                    var tr = document.createElement('tr');
                    tr.id = "tr_topf";
                    tr.innerHTML = oneItem("<?php echo e($lang->get(393)); ?>", "topf", "uitopf.jpg"); // Top Trends this week
                    document.getElementById("tbody").appendChild(tr);
                    if (visible == "true")
                        onCheckClick("topf");
                    else{
                ...
                if (id == "review") {
                    var tr = document.createElement('tr');
                    tr.id = "tr_review";
                    tr.innerHTML = oneItem("<?php echo e($lang->get(394)); ?>", "review", "uireview.jpg"); // Reviews
                    document.getElementById("tbody").appendChild(tr);
                    if (visible == "true")
                        onCheckClick("review");
                    else{
                ...
                if (id == "pop") {
                    var tr = document.createElement('tr');
                    tr.id = "tr_pop";
                    tr.innerHTML = oneItem("<?php echo e($lang->get(395)); ?>", "pop", "uidish.jpg"); // Most Popular
                    document.getElementById("tbody").appendChild(tr);
                    if (visible == "true")
                        onCheckClick("pop");
                    else{
                ...
                if (id == "cat") {
                    var tr = document.createElement('tr');
                    tr.id = "tr_cat";
                    tr.innerHTML = oneItem("<?php echo e($lang->get(396)); ?>", "cat", "uicat.jpg"); // Categories
                    document.getElementById("tbody").appendChild(tr);
                    if (visible == "true")
                        onCheckClick("cat");
                    else{
                ...
                if (id == "nearyou") {
                    var tr = document.createElement('tr');
                    tr.id = "tr_nearyou";
                    tr.innerHTML = oneItem("<?php echo e($lang->get(397)); ?>", "nearyou", "uires.jpg"); // Markets Near Your
                    document.getElementById("tbody").appendChild(tr);
                    if (visible == "true")
...
<?php echo $__env->make('bsb.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restaurants\resources\views/caLayout.blade.php ENDPATH**/ ?>