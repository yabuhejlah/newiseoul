    ...
    function fromLibrary(){
        ...
        swal({
            ...
            text: "                                <div id=\"div1\" style=\"height: 400px;position:relative;\">\n" +
                ...
                "                                            <?php $__currentLoopData = $util->getImages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>\n" +
...
<?php /**PATH /home/u958292380/domains/abg-studio.com/public_html/restaurants/resources/views/elements/imageselect.blade.php ENDPATH**/ ?>