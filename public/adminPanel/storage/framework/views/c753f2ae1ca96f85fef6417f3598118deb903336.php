...
<script>
    ...
    function paginationGoPage(page){
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '<?php echo e(url("bannersGoPage")); ?>',
            data: data,
    ...
    function buildOneItem(item){
        ...
        if (item.position == "1")
            var position = "<?php echo e($lang->get(523)); ?>";  // Banner 1
        if (item.position == "2")
            var position = "<?php echo e($lang->get(524)); ?>";  // Banner 2
    ...
    function initTableHeader(){
        var html = `
            ...
            <th><?php echo e($lang->get(70)); ?> </th>                                                                                                   
            <th><?php echo e($lang->get(48)); ?> </th>                                                                                                    
            <th><?php echo e($lang->get(511)); ?> <img onclick="tableHeaderSort('position');" src="${utilGetImg('position')}" class="img-fluid" style="margin-left: 10px; width: 20px; float: right;"></th> 
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: '<?php echo e(url("bannersDelete")); ?>',
                    data: {id: id},
                    success: function (data){
                        if (!data.ret)
...
<?php /**PATH /home/u958292380/domains/abg-studio.com/public_html/restaurants/resources/views/elements/bannersTable.blade.php ENDPATH**/ ?>