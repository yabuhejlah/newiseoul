...
<?php $__env->startSection('content'); ?>
    ...
    <div class="header">
        <div class="row clearfix">
            <div class="col-md-12">
                <h3 class=""><?php echo e($lang->get(292)); ?></h3>
            </div>
        </div>
    </div>
    <div class="body">
        ...
        <script>
            ...
            function selectUser(id){
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: '<?php echo e(url("getChatMessages")); ?>',
                    data: {
                        user_id: id,
                    },
            ...
            function sendMsg(){
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: '<?php echo e(url("chatNewMessage")); ?>',
                    data: {
                        user_id: currentId,
                        text: text,
                    },
            ...
            function buildChatUsers(){
                $.ajax({
                    ...
                    type: 'POST',
                    url: '<?php echo e(url("chatNewUsers")); ?>',
                    data: {
                    },
                    success: function (data){
                        console.log(data);
...
<?php echo $__env->make('bsb.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u958292380/domains/abg-studio.com/public_html/restaurants/resources/views/chat.blade.php ENDPATH**/ ?>