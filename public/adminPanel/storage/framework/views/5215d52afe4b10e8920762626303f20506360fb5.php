...
<?php $__env->startSection('content'); ?>
    ...
    <div class="header">
        <div class="row clearfix">
            <div class="col-md-12">
                <h3 class=""><?php echo e($lang->get(116)); ?></h3>
            </div>
        </div>
    </div>
    <div class="body">
        ...
        <ul class="nav nav-tabs tab-nav-right" role="tablist">
            ...
            <?php if($userinfo->getUserPermission("Food::ExtrasGroup::Create")): ?>
            <li role="presentation"><a href="#create" data-toggle="tab" ><h4><?php echo e($lang->get(117)); ?></h4></a></li>
            <?php endif; ?>
        ...
        <div class="tab-content">
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <div class="panel-group " id="accordion_17" role="tablist" aria-multiselectable="true">
                                    <?php $__currentLoopData = $iextrasgroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                        <div id="extrasgroup<?php echo e($data->id); ?>" class="panel panel-col-orange">
                                            <div class="panel-heading" role="tab" id="headingOne_19">
                                                <h4 class="panel-title">
                                                    ...
                                                    <a role="button" data-toggle="collapse" href="#collapse<?php echo e($data->id); ?>" aria-expanded="true" aria-controls="collapse<?php echo e($data->id); ?>">
                                                        ...
                                                        <?php if($userinfo->getUserPermission("Food::ExtrasGroup::Edit")): ?>
                                                        <img src="img/delete.png" width="70px" onclick="showDeleteMessage('<?php echo e($data->id); ?>')" align="right">
                                                        <?php endif; ?>

                                                        <?php if($userinfo->getUserPermission("Food::ExtrasGroup::Delete")): ?>
                                                        <img src="img/edit.png" width="70px" onclick="editItem('<?php echo e($data->id); ?>', '<?php echo e($data->name); ?>', '<?php echo e($data->restaurant); ?>')" align="right">
                                                        <?php endif; ?>
                                                    </a>
                                                                ...
                                                                <div class="body">
                                                                    <div class="table-responsive">
                                                                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                                                            ...
                                                                            <?php $__currentLoopData = $iextras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $idata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <?php if($idata->extrasgroup == $data->id): ?>
                                                                                    <tr id="tr<?php echo e($idata->id); ?>">
                                                                                        ...
                                                                                        <td>
                                                                                            <?php $__currentLoopData = $petani; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $dataimage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                                <?php if($dataimage->id == $idata->imageid): ?>
                                                                                                    <?php
                                                                                        ...
                                                                                        <td><?php echo e($idata->price); ?></td>
                                                                                        <td><?php echo e($idata->desc); ?></td>
                                                                                        <td>
                                                                                            <?php if($userinfo->getUserPermission("Food::Extras::Edit")): ?>
                                                                                            <button type="button" class="btn btn-default waves-effect"
                                                                                                    onclick="onEditExtras('<?php echo e($data->id); ?>', '<?php echo e($idata->id); ?>', '<?php echo e($idata->name); ?>', '<?php echo e($idata->imageid); ?>',
                                                                                                        '<?php echo e($idata->price); ?>', '<?php echo e($idata->desc); ?>', '<?php echo e($imagename); ?>')">
                                                                                                <img src="img/iconedit.png" width="25px">
                                                                                            </button>
                                                                                            <?php endif; ?>
                                                                                            <?php if($userinfo->getUserPermission("Food::Extras::Delete")): ?>
                                                                    ...
                                                                    <div align="center">
                                                                        <?php if($userinfo->getUserPermission("Food::Extras::Create")): ?>
            ...
            <div role="tabpanel" class="tab-pane fade" id="create">
                ...
                <form id="formcreate" method="post" action="<?php echo e(url('extrasgroupadd')); ?>"  >
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-2 form-control-label">
                            <label for="name"><h4><?php echo e($lang->get(89)); ?></h4></label>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group form-group-lg form-float">
                                ...
                                <label for="restaurant" class="font-12 font-bold"><p><?php echo e($lang->get(93)); ?></p></label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12 form-control-label">
                            <div align="center">
                                <button type="submit"  class="q-btn-all q-color-second-bkg waves-effect"><h5><?php echo e($lang->get(121)); ?></h5></button>
                            </div>
                        </div>
                    </div>
            ...
            <script>
                ...
                function checkForm(event) {
                    ...
                    if (sel.options[sel.selectedIndex].value == -1){
                        alertText = "<h4><?php echo e($lang->get(113)); ?></h4>";
                    }
            ...
            <div role="tabpanel" class="tab-pane fade" id="edit">
                ...
                <form id="formedit" method="post" action="<?php echo e(url('extrasgroupedit')); ?>"  >
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12 form-control-label">
                            <div align="center">
                                <button type="submit"  class="q-btn-all q-color-second-bkg waves-effect"><h5><?php echo e($lang->get(80)); ?></h5></button>
                            </div>
                        </div>
                    </div>
    ...
    <div id="formparent" hidden>
        <form id="formcreateextras" hidden>
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-2 form-control-label">
                    <label for="lat"><h4><?php echo e($lang->get(88)); ?></h4></label>
                </div>
                <div class="col-md-4">
                    <div class="form-group form-group-lg form-float">
                        <div class="form-line">
                        ...
                        <label class="font-12"><?php echo e($lang->get(92)); ?></label>
                    </div>
                </div>
            </div>
            ...
            <div class="row clearfix">
                <div class="col-md-2 form-control-label">
                    <label for="desc"><h4><?php echo e($lang->get(71)); ?></h4></label>
                </div>
                <div class="col-md-10">
                    <div class="form-group form-group-lg form-float">
                        <div class="form-line">
                        ...
                        <label class="font-12"><?php echo e($lang->get(76)); ?></label>
                    </div>
                </div>
            </div>
            ...
            <div id="dz2" class="row clearfix" hidden>
                <div class="col-md-2 form-control-label">
                    ...
                    <br>
                    <div align="center">
                        <button type="button" onclick="fromLibraryEdit()" class="q-btn-all q-color-second-bkg waves-effect"><h5><?php echo e($lang->get(77)); ?></h5></button>
                    </div>
                </div>
                <div class="col-md-10">
            ...
            <div class="row clearfix">
                <div class="col-md-12 form-control-label">
                    <div align="center">
                        <button type="submit" class="q-btn-all q-color-second-bkg waves-effect"><h5><?php echo e($lang->get(122)); ?></h5></button>
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        url: '<?php echo e(url("extrasgroupdelete")); ?>',
                        data: {id: id},
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        url: '<?php echo e(url("extrasdelete")); ?>',
                        data: {id: id},
                        success: function (data){
                            if (!data.ret)
                                return showNotification("bg-red", data.text, "bottom", "center", "", "");
...
<?php echo $__env->make('bsb.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restaurants\resources\views/extras.blade.php ENDPATH**/ ?>