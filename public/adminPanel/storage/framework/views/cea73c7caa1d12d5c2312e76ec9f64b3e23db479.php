...
<div class="col-md-4 foodm">
    <div align="right">
        ...
        <br>
        <button type="button" onclick="fromLibrary3()" class="q-btn-all q-color-second-bkg waves-effect"><h5><?php echo e($lang->get(77)); ?></h5></button>
    </div>
</div>
...
<script>
    ...
    function fromLibrary3() {
        ...
        $.ajax({
                ...
                type: 'POST',
                url: '<?php echo e(url("getImagesList")); ?>',
                data: {},
...
<?php /**PATH C:\xampp\htdocs\restaurants\resources\views/elements/form/image2.blade.php ENDPATH**/ ?>