                    ...
                    <div class="col-md-12">
                        <div align="right">
                            <?php if($userinfo->getUserPermission("Restaurants::TopRestaurants::Add")): ?>
                                <button type="button" onclick="selectFood()" class="q-btn-all q-color-second-bkg waves-effect"><h5><?php echo e($lang->get(186)); ?></h5></button>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <script>
                function selectFood(){
                    ...
                    <?php $__currentLoopData = $restaurants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        text = text + "<td><div onclick=\"addToList(<?php echo e($data->id); ?>)\" class=\"q-btn-all q-color-second-bkg waves-effect\"><h5><?php echo e($lang->get(181)); ?></h5></div></td></tr>";
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        text = text + "                </tbody>\n" +
                        "                </tbody>\n" +
                        "                </table>\n</div></div></div>"
...
<?php echo $__env->make('bsb.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restaurants\resources\views/toprestaurants2.blade.php ENDPATH**/ ?>