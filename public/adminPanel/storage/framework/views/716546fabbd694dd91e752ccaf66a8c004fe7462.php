...
<?php $__env->startSection('content'); ?>
    ...
    <div class="header">
        <div class="row clearfix">
            <div class="col-md-12">
                <h3 class=""><?php echo e($lang->get(254)); ?></h3>
            </div>
        </div>
    </div>
    ...
    <div class="body">
        ...
        <ul id="tabs" class="nav nav-tabs tab-nav-right" role="tablist">
            ...
            <?php if($userinfo->getUserPermission("Coupons::Create")): ?>
                                ...
                                <div class="table-responsive">
                                    <table id="data_table" class="table table-bordered table-striped table-hover dataTable js-exportable" data-order="[[ 0, &quot;asc&quot; ]]">
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo e($lang->get(256)); ?></th>
                                            <th><?php echo e($lang->get(257)); ?></th>
                                            <th><?php echo e($lang->get(258)); ?></th>
                                            <th><?php echo e($lang->get(259)); ?></th>
                                            <th><?php echo e($lang->get(260)); ?></th>
                                        ...
                                        <tbody id="table">
                                            ...
                                            <?php $__currentLoopData = $coupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr id="tr<?php echo e($data->id); ?>">
                                                    ...
                                                    <td>
                                                        <?php if($data->inpercents == '1'): ?>
                                                            <?php echo e($data->discount); ?>%
                                                        <?php else: ?>
                                                            <?php echo e($currency->makePrice($data->discount)); ?>
                                                    ...
                                                    <td>
                                                        <?php echo e($data->dateStart); ?>

                                                    </td>

                                                    <td>
                                                        <?php echo e($data->dateEnd); ?>
                                                    ...
                                                    <td>
                                                        <?php if($userinfo->getUserPermission("Coupons::Edit")): ?>
                                                        <button type="button" class="btn btn-default waves-effect"
                                                                onclick="editItem('<?php echo e($data->id); ?>')">
                                                            <img src="img/iconedit.png" width="25px">
                                                        </button>
                                                        <?php endif; ?>
                                                        <?php if($userinfo->getUserPermission("Coupons::Delete")): ?>
                ...
                <div id="form" class="row clearfix">
                    ...
                    <div class="col-md-12 foodm">
                        ...
                        <div class="col-md-12 foodm">
                            <div class="col-md-2 foodm">
                                <h4 align="right"><?php echo e($lang->get(256)); ?>: <span class="col-red">*</span></h4>
                            </div>
                            <div class="col-md-2 foodm">
                        ...
                        <div class="col-md-12 foodm">
                            <div class="col-md-2 foodm">
                                <h4 align="right"><?php echo e($lang->get(257)); ?>: <span class="col-red">*</span></h4>
                            </div>
                            <div class="col-md-2 foodm">
                                <div class="form-group form-group-lg form-float">
                                    <div class="form-line">
                            ...
                            <div class="col-md-3 foodm">
                                <h4 align="right"><?php echo e($lang->get(262)); ?>: </h4>
                            </div>
                            <div class="col-md-2 foodm">
                                <div class="form-group form-group-lg form-float">
                                    <div class="form-line">
                                        <input type="number" id="amount" name="amount" class="form-control" value="0">
                                        <label class="form-label"><?php echo e($lang->get(263)); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 foodm">
                            <div class="col-md-2 foodm">
                                <h4 align="right"><?php echo e($lang->get(71)); ?>: </h4>
                            </div>
                            <div class="col-md-10 foodm">
                                <div class="form-group form-group-lg form-float">
                                    ...
                                    <p><?php echo e($lang->get(76)); ?>. <?php echo e($lang->get(264)); ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 foodm">
                            <div class="col-md-2 foodm">
                                <h4 align="right"><?php echo e($lang->get(265)); ?>: </h4>
                            </div>
                            <div class="col-md-3 foodm">
                                <div class="form-group form-group-lg form-float">
                                    <div class="form-line">
                            ...
                            <div class="col-md-2 foodm">
                                <h4 align="right"><?php echo e($lang->get(266)); ?>: <span class="col-red">*</span></h4>
                            </div>
                            <div class="col-md-3 foodm">
                                <div class="form-group form-group-lg form-float">
                                    <div class="form-line">
                        ...
                        <div class="col-md-12 foodm">
                            ...
                            <div class="col-md-12 foodm">
                                <div class="col-md-6 foodm">
                                    <label for="restaurantsGroup"><h4><?php echo e($lang->get(267)); ?></h4></label>
                                </div>
                                <div class="col-md-6 foodm">
                            ...
                            <select id="restaurantsGroup" class="ms" multiple="multiple">
                                <optgroup label="<?php echo e($lang->get(8)); ?>">    <!--Restaurants-->
                                    <?php $__currentLoopData = $restaurants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $idata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($idata->id); ?>" style="font-size: 16px  !important;"><?php echo e($idata->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </optgroup>
                            </select>
                        </div>
                        ...
                        <div class="col-md-12 foodm" style="margin-top: 20px;">
                            ...
                            <div class="col-md-12 foodm">
                                <div class="col-md-6 foodm">
                                    <label for="categoryGroup"><h4><?php echo e($lang->get(268)); ?></h4></label>
                                </div>
                                <div class="col-md-6 foodm">
                            ...
                            <select id="categoryGroup" class="ms" multiple="multiple">
                                <optgroup label="<?php echo e($lang->get(396)); ?>">    <!--Categories-->
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $idata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($idata->id); ?>" style="font-size: 16px  !important;"><?php echo e($idata->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </optgroup>
                            </select>
                        ...
                        <div class="col-md-12 foodm" style="margin-top: 20px;">
                            ...
                            <div class="col-md-12 foodm">
                                <div class="col-md-6 foodm">
                                    <label for="foodsGroup"><h4><?php echo e($lang->get(269)); ?></h4></label>
                                </div>
                                <div class="col-md-6 foodm">
                            ...
                            <select id="foodsGroup" class="ms" multiple="multiple">
                                <optgroup label="<?php echo e($lang->get(1)); ?>">    <!--Foods-->
                                    <?php $__currentLoopData = $foods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $idata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($idata->id); ?>" style="font-size: 16px  !important;"><?php echo e($idata->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </optgroup>
                            </select>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12 form-control-label">
                            <hr>
                            <div align="center">
                                <button type="button" onclick="save();" class="btn btn-primary m-t-15 waves-effect "><h5><?php echo e($lang->get(270)); ?></h5></button>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        <?php $__currentLoopData = $foods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $idata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            allFoods.push(["<?php echo e($idata->id); ?>", "<?php echo e($idata->name); ?>", "<?php echo e($idata->restaurant); ?>"])
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        function onCheckClick(id){
            ...
            if (id == 'published') {
                ...
                published = !published;
                document.getElementById(id).innerHTML = "<img src=\"img/check_"+value+".png\" width=\"25px\">&nbsp <?php echo e($lang->get(271)); ?>";
            }
            if (id == 'allRestaurants') {
                ...
                document.getElementById(id).innerHTML = "<img src=\"img/check_"+value+".png\" width=\"25px\">&nbsp <?php echo e($lang->get(272)); ?>";
            }
            if (id == 'allCategoryGroup') {
                ...
                document.getElementById(id).innerHTML = "<img src=\"img/check_"+value+".png\" width=\"25px\">&nbsp <?php echo e($lang->get(273)); ?>";
            }
            if (id == 'allFoodsGroup') {
                ...
                document.getElementById(id).innerHTML = "<img src=\"img/check_"+value+".png\" width=\"25px\">&nbsp <?php echo e($lang->get(274)); ?>";
            }
            if (id == 'inpercents') {
                if (inpercents == true){
                    value = "off";
                ...
                document.getElementById(id).innerHTML = "<img src=\"img/check_"+value+".png\" width=\"25px\">&nbsp <?php echo e($lang->get(275)); ?>";
            }
        }
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        url: '<?php echo e(url("coupondelete")); ?>',
                        data: {id: id},
                        success: function (data){
                            console.log(data);
                            if (data.ret == 401)
                                return window.location="<?php echo e(route('/')); ?>";
                            if (data.ret == 402)
        ...
        async function editItem(id) {
            $.ajax({
                ...
                success: function (data){
                    ...
                    if (data.published == '1') {
                        published = true;
                        document.getElementById('published').innerHTML = "<img src=\"img/check_on.png\" width=\"25px\">&nbsp <?php echo e($lang->get(271)); ?>";
                    }else{
                        published = false;
                        document.getElementById('published').innerHTML = "<img src=\"img/check_off.png\" width=\"25px\">&nbsp <?php echo e($lang->get(271)); ?>";
                    }
                    if (data.allRestaurants == '1'){
                        allRestaurants = true;
                        document.getElementById('allRestaurants').innerHTML = "<img src=\"img/check_on.png\" width=\"25px\">&nbsp <?php echo e($lang->get(272)); ?>";
                        document.getElementById("ms-restaurantsGroup").hidden=true;
                    }else{
                        allRestaurants = false;
                        document.getElementById('allRestaurants').innerHTML = "<img src=\"img/check_off.png\" width=\"25px\">&nbsp <?php echo e($lang->get(272)); ?>";
                        document.getElementById("ms-restaurantsGroup").hidden=false;
                    }
                    if (data.allCategory == '1'){
                        allCategoryGroup = true;
                        document.getElementById('allCategoryGroup').innerHTML = "<img src=\"img/check_on.png\" width=\"25px\">&nbsp <?php echo e($lang->get(273)); ?>";
                        document.getElementById("ms-categoryGroup").hidden=true;
                    }else{
                        allCategoryGroup = false;
                        document.getElementById('allCategoryGroup').innerHTML = "<img src=\"img/check_off.png\" width=\"25px\">&nbsp <?php echo e($lang->get(273)); ?>";
                        document.getElementById("ms-categoryGroup").hidden=false;
                    }
                    if (data.allFoods == '1'){
                        allFoodsGroup = true;
                        document.getElementById('allFoodsGroup').innerHTML = "<img src=\"img/check_on.png\" width=\"25px\">&nbsp <?php echo e($lang->get(274)); ?>";
                        document.getElementById("ms-foodsGroup").hidden=true;
                    }else{
                        allFoodsGroup = false;
                        document.getElementById('allFoodsGroup').innerHTML = "<img src=\"img/check_off.png\" width=\"25px\">&nbsp <?php echo e($lang->get(274)); ?>";
                        document.getElementById("ms-foodsGroup").hidden=false;
                    }
                    document.getElementById("discount").value = data.discount;
                    if (data.inpercents == '1'){
                        inpercents = true;
                        document.getElementById('inpercents').innerHTML = "<img src=\"img/check_on.png\" width=\"25px\">&nbsp <?php echo e($lang->get(275)); ?>";
                        document.getElementById("discount").addEventListener('input',  listener100);
                    }else{
                        inpercents = false;
                        document.getElementById('inpercents').innerHTML = "<img src=\"img/check_off.png\" width=\"25px\">&nbsp <?php echo e($lang->get(275)); ?>";
        ...
        function save(){
            ...
            if (name.length == 0)
                return showNotification("bg-red", "<?php echo e($lang->get(85)); ?>", "bottom", "center", "", "");
            var discount = document.getElementById("discount").value;
            if (discount.length == 0)
                return showNotification("bg-red", "<?php echo e($lang->get(276)); ?>", "bottom", "center", "", "");
            ...
            if (dateEnd.length == 0)
                return showNotification("bg-red", "<?php echo e($lang->get(277)); ?>", "bottom", "center", "", "");
            ...
            $.ajax({
                ...
                success: function (data){
                    console.log(data);
                    if (data.ret == 5)
                        return showNotification("bg-red", "<?php echo e($lang->get(278)); ?>", "bottom", "center", "", "");
                    if (data.ret == 6)
                        return showNotification("bg-red", "<?php echo e($lang->get(279)); ?>", "bottom", "center", "", "");
                    var div = document.createElement("tr");
                    //var buttons = addButtonsToExtra(currentGroupId, eid, name, eimage, eprice, desc);
                    var buttons = "";
                    var disc = discount2 + "%";
                    if (inpercents == '0') {
                        disc = parseFloat(discount2).toFixed(<?php echo e($currency->symbolDigits()); ?>);
                        if (<?php echo e($currency->rightSymbol()); ?> == "false")
                            disc = disc + '<?php echo e($currency->currency()); ?>';
                        else
                            disc = '<?php echo e($currency->currency()); ?>' + disc;
                    }
...
<?php echo $__env->make('bsb.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u958292380/domains/abg-studio.com/public_html/restaurants/resources/views/coupons.blade.php ENDPATH**/ ?>