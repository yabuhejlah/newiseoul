...
<?php $__env->startSection('content'); ?>
    <div class="header">
        <div class="row clearfix">
            <div class="col-md-12">
                <h3 class=""><?php echo e($lang->get(133)); ?></h3>
            </div>
        </div>
    </div>
    <div class="body">
    ...
    <!-- Tabs -->
        ...
        <ul class="nav nav-tabs tab-nav-right" role="tablist">
            ...
            <?php if($userinfo->getUserPermission("Food::Reviews::Create")): ?>
                                    ...
                                    <table id="data_table" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                        ...
                                        <?php $__currentLoopData = $idata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr id="tr<?php echo e($data->id); ?>">
                                                ...
                                                <td>
                                                <?php $__currentLoopData = $ifoods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $idata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($idata->id == $data->food): ?>
                                                        <?php echo e($idata->name); ?>
                                                ...
                                                <td>
                                                    <?php if($userinfo->getUserPermission("Food::Reviews::Edit")): ?>
                                                    <button type="button" class="btn btn-default waves-effect"
                                                            onclick="editItem('<?php echo e($data->id); ?>',
                                                                '<?php echo e($data->user); ?>', '<?php echo e($data->food); ?>',
                                                                '<?php echo e($data->rate); ?>', '<?php echo e($data->desc); ?>',
                                                                )">
                                                        <img src="img/iconedit.png" width="25px">
                                                    </button>
                                                    <?php endif; ?>
                                                    <?php if($userinfo->getUserPermission("Food::Reviews::Delete")): ?>
        ...
        <form id="formcreate" method="post" action="<?php echo e(url('foodreviewsadd')); ?>"  >
            ...
            <div class="row clearfix">
                <div class="col-md-2 form-control-label">
                    <label for="name"><h4><?php echo e($lang->get(137)); ?></h4></label>
                </div>
                <div class="col-md-4">
                    <select name="user" id="user" class="q-form-s show-tick q-radius" style="font-size: 26px  !important; ">
                ...
                <div class="col-md-2 form-control-label">
                    <label><h4><?php echo e($lang->get(138)); ?></h4></label>
                </div>
                <div class="col-md-4">
                        <select name="food" id="food" class="q-form-s show-tick q-radius" style="font-size: 26px  !important; ">
                            <option value="-1" style="font-size: 18px  !important;"><?php echo e($lang->get(114)); ?></option>
                            <?php $__currentLoopData = $ifoods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="row clearfix">
                <div class="col-md-2 form-control-label">
                    <label><h4><?php echo e($lang->get(136)); ?></h4></label>
                </div>
                <div class="col-md-4">
            ...
            <div class="row clearfix">
                <div class="col-md-2 form-control-label">
                    <label><h4><?php echo e($lang->get(140)); ?></h4></label>
                </div>
                <div class="col-md-10">
            ...
            <div class="row clearfix">
                <div class="col-md-12 form-control-label">
                    <div align="center">
                    <button type="submit"  class="q-btn-all q-color-second-bkg waves-effect"><h5><?php echo e($lang->get(142)); ?></h5></button>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function checkForm(event) {
            ...
            if (sel.options[sel.selectedIndex].value == -1){
                alertText = "<h4><?php echo e($lang->get(143)); ?></h4>";
            }
    ...
    <!-- Tab Edit -->
        ...
        <div role="tabpanel" class="tab-pane fade" id="edit">
            ...
            <form id="formedit" method="post" action="<?php echo e(url('foodreviewsedit')); ?>"  >
                <?php echo csrf_field(); ?>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-4">
                                <select name="user" id="userEdit" class="q-form-s show-tick q-radius" style="font-size: 26px  !important; ">
                                    <?php $__currentLoopData = $iusers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $datausers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($datausers->id); ?>" style="font-size: 18px  !important;"><?php echo e($datausers->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                    ...
                    <div class="col-md-2 form-control-label">
                        <?php echo e($lang->get(138)); ?>

                    </div>
                    <div class="col-md-4">
                            <select name="food" id="foodEdit" class="q-form-s show-tick q-radius" style="font-size: 26px  !important; ">
                                <option value="-1" style="font-size: 18px  !important;"><?php echo e($lang->get(114)); ?></option>
                                <?php $__currentLoopData = $ifoods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($data->id); ?>" style="font-size: 18px  !important;"><?php echo e($data->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="row clearfix">
                    <div class="col-md-2 form-control-label">
                        <label for="name"><h4><?php echo e($lang->get(136)); ?></h4></label>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group form-group-lg">
                            ...
                            <label class="font-12"><?php echo e($lang->get(139)); ?></label>
                        </div>
                    </div>
                </div>
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        url: '<?php echo e(url("foodreviewsdelete")); ?>',
                        data: {id: id},
...
<?php echo $__env->make('bsb.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restaurants\resources\views/foodreviews.blade.php ENDPATH**/ ?>