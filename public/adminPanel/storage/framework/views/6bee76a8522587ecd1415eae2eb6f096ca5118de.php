                    ...
                    <div class="col-md-12 foodm">
                        ...
                        <div class="col-md-12 foodm">
                            ...
                            <div class="col-md-3 form-control-label">
                                <div align="center">
                                    <button type="submit" class="q-btn-all q-color-second-bkg waves-effect"><h5><?php echo e($lang->get(329)); ?></h5></button>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-12 form-control-label">
                                        <div align="center">
                                            <button type="submit" class="q-btn-all q-color-second-bkg waves-effect"><h5><?php echo e($lang->get(339)); ?></h5></button>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('bsb.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restaurants\resources\views/currencies.blade.php ENDPATH**/ ?>