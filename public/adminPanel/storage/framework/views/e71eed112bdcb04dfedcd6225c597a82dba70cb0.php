                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-default waves-effect"
                                                            onclick="editItem('<?php echo e($data->id); ?>','<?php echo e($data->name); ?>', '<?php echo e($data->published); ?>', '<?php echo e($data->imageid); ?>',
                                                                ...
                                                                '<?php echo e($data->lat); ?>', '<?php echo e($data->lng); ?>', '<?php echo e($data->fee); ?>', '<?php echo e($data->percent); ?>', '<?php echo e($data->minAmount); ?>', '<?php echo e($data->perkm); ?>')">
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-6 foodm">
                    ...
                    <div class="col-md-8 foodm">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <label for="percent" class="form-label"><h5><?php echo e($lang->get(159)); ?></h5></label>     
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="checkbox" id="perkm" name="perkm" class="filled-in checkmark">
                                <label for="perkm" class="form-label"><h5><?php echo e($lang->get(611)); ?></h5></label>     
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 info q-mb20" style="margin-top: 5px; margin-left: 20px;">
                        ...
                        <p id="current"><?php echo e($lang->get(162)); ?>: <?php echo e($currency->currency()); ?>0</p> 
                    </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-6 foodm">
                        ...
                        <div class="col-md-12 info" style="margin-top: 5px; margin-left: 20px;">
                            <h4><?php echo e($lang->get(160)); ?></h4>
                            <p><?php echo e($lang->get(161)); ?></p>
                            <p id="currentEdit"><?php echo e($lang->get(162)); ?>: <?php echo e($currency->currency()); ?>0</p>
                        </div>
    ...
    <script type="text/javascript">
        ...
        async function editItem(id, name, visible, imageid, ifile, desc,
            ...
            if (percent == '1')
                ...
                currentEdit.innerHTML = "Current: <?php echo e($currency->currency()); ?>"+fee;
            //
            <?php $__currentLoopData = $restaurants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        percent.addEventListener('change', (event) => {
            ...
            if (event.target.checked) {
                ...
                current.innerHTML = "Current: <?php echo e($currency->currency()); ?>"+vl;
            }
        })
        ...
        percentEdit.addEventListener('change', (event) => {
            ...
            if (event.target.checked) {
                ...
                currentEdit.innerHTML = "Current: <?php echo e($currency->currency()); ?>"+vl;
            }
        })
    ...
    percentEdit.addEventListener('change', (event) => {
        ...
        if (event.target.checked) {
            ...
            if (perkmEdit.checked)
                currentEdit.innerHTML = "Current: <?php echo e($currency->currency()); ?>" + vl + " per km or ml"
            else
                currentEdit.innerHTML = "Current: <?php echo e($currency->currency()); ?>"+vl;
        }
    });
...
<?php echo $__env->make('bsb.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restaurants\resources\views/restaurants.blade.php ENDPATH**/ ?>