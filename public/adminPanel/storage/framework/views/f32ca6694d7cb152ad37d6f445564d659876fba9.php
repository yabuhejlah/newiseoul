                ...
                <form id="formcreate" method="post" action="<?php echo e(url('sendmsg')); ?>"  >
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12 form-control-label">
                            <div align="center">
                                <button type="submit" class="q-btn-all q-color-second-bkg waves-effect"><h5><?php echo e($lang->get(291)); ?></h5></button>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('bsb.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restaurants\resources\views/notify.blade.php ENDPATH**/ ?>