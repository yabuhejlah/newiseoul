                ...
                <form id="formcreate" method="post" action="<?php echo e(url('extrasgroupadd')); ?>"  >
                    ...
                    <div class="row clearfix">
                        <div class="col-md-12 form-control-label">
                            <div align="center">
                                <button type="submit"  class="btn btn-primary m-t-15 waves-effect "><h5><?php echo e($lang->get(121)); ?></h5></button>
                            </div>
                        </div>
                    </div>
    ...
    <div id="formparent" hidden>
        <form id="formcreateextras" hidden>
            ...
            <div class="row clearfix">
                <div class="col-md-12 form-control-label">
                    <div align="center">
                        <button type="submit" class="btn btn-primary m-t-15 waves-effect "><h5><?php echo e($lang->get(122)); ?></h5></button>
...
<?php echo $__env->make('bsb.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u958292380/domains/abg-studio.com/public_html/restaurants/resources/views/extras.blade.php ENDPATH**/ ?>