...
<div class="table-responsive">
    ...
    <div class="col-md-12" style="margin-bottom: 10px">
        ...
        <div class="col-md-3" style="margin-bottom: 0px">
            <?php echo $__env->make('elements.search.selectCat', array('text' => $lang->get(90), 'id' => "cat_search", 'onchange' => "onCatSearchSelect(this)"), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>  
        </div>
        <div class="col-md-3" style="margin-bottom: 0px">
...
<script>
    ...
    function initTableHeader(){
        var html = `
            ...
            <th><?php echo e($lang->get(70)); ?> </th>                                                                                                   
            <th><?php echo e($lang->get(88)); ?> <img <img onclick="tableHeaderSort('price');" src="${utilGetImg('price')}" class="img-fluid" style="margin-left: 10px; width: 20px; float: right;"></th> 
            <th><?php echo e($lang->get(96)); ?> <img <img onclick="tableHeaderSort('discountprice');" src="${utilGetImg('discountprice')}" class="img-fluid" style="margin-left: 10px; width: 20px; float: right;"></th> 
            <th><?php echo e($lang->get(89)); ?> <img <img onclick="tableHeaderSort('restaurant');" src="${utilGetImg('restaurant')}" class="img-fluid" style="margin-left: 10px; width: 20px; float: right;"></th> 
            <th><?php echo e($lang->get(90)); ?> <img <img onclick="tableHeaderSort('category');" src="${utilGetImg('category')}" class="img-fluid" style="margin-left: 10px; width: 20px; float: right;"></th> 
            <th><?php echo e($lang->get(73)); ?> <img onclick="tableHeaderSort('published');" src="${utilGetImg('published')}" class="img-fluid" style="margin-left: 10px; width: 20px; float: right;"></th> 
...
<?php /**PATH /home/u958292380/domains/abg-studio.com/public_html/restaurants/resources/views/elements/foodsTable.blade.php ENDPATH**/ ?>