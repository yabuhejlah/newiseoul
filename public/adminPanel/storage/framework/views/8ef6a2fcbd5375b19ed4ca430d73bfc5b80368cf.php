            ...
            <div role="tabpanel" class="tab-pane fade" id="create">
                ...
                <div id="form">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6 ">
                            <?php echo $__env->make('elements.form.images', array(), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <div class="col-md-12 mb-0">
                        ...
                        <div class="col-md-3 align-left">
                            <?php echo $__env->make('elements.form.button', array('label' => $lang->get(545), 'onclick' => "onProductVariants();"), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>  
                        </div>
                        <div id="productVariantsItems" class="col-md-12 " hidden>
                            ...
                            <div class="col-md-12 " style="border-color: #2aabd2; border-style: dashed; border-width: 2px; border-radius: 10px ">
                                <div class="col-md-6 q-mt20 q-mb20">
                                    <?php echo $__env->make('elements.form.text', array('label' => $lang->get(69), 'text' => $lang->get(91), 'id' => "pv_name", 'request' => "true", 'maxlength' => "40"), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>  
                                    <?php echo $__env->make('elements.form.price', array('label' => $lang->get(88), 'text' => $lang->get(92), 'id' => "pv_price", 'request' => "true"), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>  
                                    <?php echo $__env->make('elements.form.price', array('label' => $lang->get(96), 'text' => $lang->get(97), 'id' => "pv_discountprice", 'request' => "false"), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>  
                                </div>
                                <div class="col-md-6" style="margin-top: 10px">
                                    <?php echo $__env->make('elements.form.image2', array(), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php echo $__env->make('elements.form.button', array('label' => $lang->get(546), 'onclick' => "addVariant();"), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>  
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
    ...
    <script type="text/javascript">
        ...
        function addVariant(){
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?php echo e(url("productVariantsAdd")); ?>',
                data: {
                    id: editId,
                    name: pv_name,
                    price: pv_price,
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="q-btn-all q-color-alert waves-effect" onclick="deleteVariableItem('${item.id}')">
                                <div><?php echo e($lang->get(308)); ?></div> 
                </button>
            </td>
        </tr>
`
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        ...
                        type: 'POST',
                        url: '<?php echo e(url("productVariantsDelete")); ?>',
                        data: {
                            id: id,
                            parent: editId,
                        },
...
<?php echo $__env->make('bsb.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restaurants\resources\views/foods.blade.php ENDPATH**/ ?>