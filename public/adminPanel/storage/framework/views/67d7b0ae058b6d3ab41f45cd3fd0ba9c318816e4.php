        ...
        <hr>
            ...
            <form id="form" method="post" action="<?php echo e(url('settingsSetLang')); ?>"  >
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-4">
                        <button type="submit" class="q-btn-all q-color-second-bkg waves-effect"><h5><?php echo e($lang->get(437)); ?></h5></button>   
                    </div>
                </div>
...
<?php echo $__env->make('bsb.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restaurants\resources\views/settings.blade.php ENDPATH**/ ?>