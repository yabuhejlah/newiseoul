                ...
                <div class="row col-md-12 q-mt10">
                    <div class="col-md-1 px-0 col-xs-1">
                        <a href="<?php echo e(route('/')); ?>">
                            <img src="<?php echo e($theme->getLogo()); ?>" class="img-fluid" style="max-height: 80px; position: absolute">
                        </a>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\vmarkets_shop\resources\views/elements/header.blade.php ENDPATH**/ ?>