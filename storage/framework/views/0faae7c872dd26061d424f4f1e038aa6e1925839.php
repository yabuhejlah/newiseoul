...
<div class="shop-page-container mb-50 ">
    <div class="container ">
        <?php if($page == "login"): ?>
            <?php echo $__env->make('elements.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        <?php if($page == "forgot"): ?>
            <?php echo $__env->make('elements.forgot', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        <?php if($page == "register"): ?>
            <?php echo $__env->make('elements.register', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        <?php if($page == "account"): ?>
            <?php echo $__env->make('elements.account', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\restaurants_site\resources\views/account.blade.php ENDPATH**/ ?>