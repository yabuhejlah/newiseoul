                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-6 col-xs-12">
                        <div class="product-feature-details">
                            ...
                            <div id="variants_details" class="cart-buttons mb-20">
                            </div>
                            ...
                            <div class="cart-buttons mb-20">
                                ...
                                <div class="add-to-cart-btn">
                                    <a href="#" onClick="addToBasket();"><i class="fa fa-shopping-cart"></i><?php echo e($lang->get(49)); ?> </a>  
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function openModal(id){
        ...
        $.ajax({
            ...
            success: function (data){
                    ...
                    data.food.variants.forEach(function(item, i, arr) {
                        ...
                        if (item.dprice2 != "")
                            var textPrice2 = `<span class="main-price" style="font-weight: 400; font-size: 25px; float: right; margin-left: 10px; text-decoration: line-through; color: #999; margin-top: 15px">${item.price2}</span>
                                <span class="discounted-price" style="font-weight: 400; float: right; font-size: 25px; color: #<?php echo e($theme->getMainColor()); ?>; margin-top: 15px"> ${item.dprice2}</span>`;
                        else
                ...
                document.getElementById("variants_details").innerHTML = t;
                drawRadios();
                mainPrice();
            },
            error: function(e) {
    ...
    function drawRadios(){
        arrayVariants.forEach(function(item, i, arr) {
            drawRadio(`radio${item.id}`, item.select, "#<?php echo e($theme->getMainColor()); ?>");
        });
        mainPrice();
    }
...
<?php /**PATH C:\xampp\htdocs\vmarkets_shop\resources\views/elements/dialogDetails.blade.php ENDPATH**/ ?>