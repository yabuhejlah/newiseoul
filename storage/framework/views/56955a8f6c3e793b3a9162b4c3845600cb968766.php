...
.product-categories li a{
    color: #<?php echo e($theme->getMainColor()); ?>;
}

.product-categories li:hover a{
    color: #<?php echo e($theme->getMainColorHover()); ?>;
}

.product-categories li:hover canvas{
    background-color: #<?php echo e($theme->getMainColorHover()); ?>;
}

.q-banner{
    max-height: <?php echo e($theme->getBannerHeight()); ?>;;
    width: 100%;
    object-fit: contain;
}
...
.q-slider {
    position: relative;
    height: <?php echo e($theme->getSliderProductHeight()); ?>;
...
.product-hover-icons a:hover {
    background: #<?php echo e($theme->getMainColorHover()); ?>;
}
...
.single-product-content-container .small-image-slider-single-product-tabstyle-3 .slick-arrow:hover {
    background: #<?php echo e($theme->getMainColor()); ?>;
    color: #fff;
    border-color: #<?php echo e($theme->getMainColor()); ?>; }
...
.single-product-content-container .product-feature-details .color span.active {
    border: 2px solid #<?php echo e($theme->getMainColor()); ?>;
    width: 32px;
    height: 32px; }
    ...
    .cart-floating-box .cart-float-single-item .cart-float-single-item-image {
      ...
      .cart-floating-box .cart-float-single-item .cart-float-single-item-image a {
        ...
        .cart-floating-box .cart-float-single-item .cart-float-single-item-image a:hover {
          border: 1px solid #<?php echo e($theme->getMainColor()); ?>; }
...
.saved-message {
  border-top: 3px solid #<?php echo e($theme->getMainColor()); ?>;
...
<?php /**PATH C:\xampp\htdocs\restaurants_site\resources\views/elements/maincss.blade.php ENDPATH**/ ?>