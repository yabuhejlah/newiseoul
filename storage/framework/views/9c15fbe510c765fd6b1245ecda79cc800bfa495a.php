            ...
            user_address.forEach(function (data) {
                ...
                if (value) {
                    ...
                    if (t > shop_address.shopArea){
                        document.getElementById("next-button-2").hidden = true;
                        document.getElementById("too-far").innerHTML = `<p style="color: red">          
                                <?php echo e($lang->get(158)); ?> (${t.toFixed(3)} <?php echo e($settings->getKmOrMiles()); ?>). </p>
                               <div><?php echo e($lang->get(160)); ?>: ${shop_address.shopArea.toFixed(0)} <?php echo e($settings->getKmOrMiles()); ?></div> 
                                <br>
                                `;
                    }else{
                        document.getElementById("too-far").innerHTML = `<p><?php echo e($lang->get(159)); ?> (${t.toFixed(3)} <?php echo e($settings->getKmOrMiles()); ?>). </p><br>`; 
                    }
                }
            });
        }
...
<?php /**PATH C:\xampp\htdocs\restaurants_site\resources\views/cart.blade.php ENDPATH**/ ?>