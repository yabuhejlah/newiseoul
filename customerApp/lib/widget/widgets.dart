...
headerMenuWidget(var context, Function(String) callback, Color _color, String title){
  return _headerWidget2(context, callback, theme.primarySwatch, title, _buttonMenu(callback, _color));
}

headerWidget(var context, Function(String) callback, Color _color, String title){
  return _headerWidget2(context, callback, theme.primarySwatch, title, _buttonBack(callback, _color));
}
  ...
  return Container(
    ...
    child: Row(
      children: [
        ...
        if (_userAuth)
          _chat(callback, theme.primarySwatch),
        if (_userAuth)
          _notify(callback, theme.primarySwatch),
        _shopping(callback, theme.primarySwatch),
        if (_userAuth)
          _avatar(callback, theme.primarySwatch),
      ],
    ),
  );
}
...
headerBackButtonWithBasket(var context, Function(String) callback, Color _color){
  ...
  child: Row(
      children: [
        _buttonBack((String _){Navigator.pop(context);}, theme.primarySwatch),
              ...
              child: UnconstrainedBox(
                  child: Container(
                      ...
                      child: Image.asset("assets/notifyicon.png",
                        fit: BoxFit.contain, color: Colors.orangeAccent,
                      )
                  )),
            ),
              ...
              child: UnconstrainedBox(
                  child: Container(
                      ...
                      child: Image.asset("assets/chat.png",
                        fit: BoxFit.contain, color: theme.primarySwatch,
                      )
                  )),
            ),
