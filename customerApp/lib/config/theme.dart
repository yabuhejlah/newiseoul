...
class AppThemeData{
  ...
  Color colorPrimary = Color(0xff0a9201);
  Color colorCompanion = Color(0xff075f01);
  var colorsVendorGradient = [Color(0xffd8c898).withAlpha(100),  Color(
      0xffaa9557), Color(
      0xff755930), Color(
      0xff433518),];
...
var _backgroundDarkColor = Color(0xFF494949);
