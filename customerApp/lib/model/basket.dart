...
print("getSubTotal present in foods list=${_coupon.foodsList} need=${food.id}");
          }else{
          ...
          if (priceCoupon != price)
            print("getSubTotal food ${food.id}:${food.name} IN ACTION. ${_getItemPriceDEBUG(food)} WITH COUPON=${_couponCalculateDEBUG(price)}");
          else{
