...
class ChatMessages {
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> ChatMessages = new Map<String, dynamic>();
    ChatMessages['id'] = id;
    ChatMessages['date'] = date;
    ChatMessages["text"] = text;
    ChatMessages["author"] = author;
    ChatMessages["delivered"] = delivered;
    ChatMessages["read"] = read;
    return ChatMessages;
  }
}
